/**
 * Page switch transition animation using the View Transitions API.
 *
 * Performs a circular clip-path reveal/hide animation centered on a toggle
 * element when the browser supports `document.startViewTransition`. Falls
 * back to simply invoking the callback when the API is unavailable or the
 * user prefers reduced motion.
 */
export async function pageSwitchAnimate (
  toggle: HTMLElement,
